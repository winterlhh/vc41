...
export interface ApiProfileProfile extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Site owner profile information';
    displayName: 'Profile';
    pluralName: 'profiles';
  ...
  attributes: {
    ...
    backgroundSrc: Schema.Attribute.String;
    bio: Schema.Attribute.Text;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    likeCount: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    likeLabel: Schema.Attribute.String & Schema.Attribute.DefaultTo<'Like'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::profile.profile'
...
export interface ApiSocialLinkSocialLink extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Social media link entries';
  ...
  attributes: {
    ...
    platform: Schema.Attribute.Enumeration<
      ['instagram', 'medium', 'linkedin', 'twitter', 'youtube', 'github']
    > &
      Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
